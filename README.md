...
Проект включает комплексную систему тестирования с моковыми данными:

- **94 теста** покрывают солвер, хелперы и генератор данных
- **7 тестовых наборов** с различными сценариями (6 ядер разных редкостей, 100+ рунитов)
- **Автоматическая генерация** тестовых данных с учётом игровых ограничений
